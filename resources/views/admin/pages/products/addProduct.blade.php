                            ...
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="single-select form-control" name="category" value="{{ old('category') }}" required>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="single-select form-control" name="brand" value="{{ old('brand') }}" required>
                                                <option value="" selected>Select</option>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" name="minimum_purchase_qty" class="form-control" placeholder="Minimum purchase qty" value="{{ old('minimum_purchase_qty') }}" required>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputPhoneNo2" class="col-sm-3 col-form-label">Thumbnail Image (300x300) <span class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                            ...
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="number" step="0.1" name="selling_price" class="form-control" value="{{ old('selling_price') }}" required>
                                            @error('selling_price')
                                                <p class="mb-0 text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="datetime-local" name="discount_from" class="form-control" value="{{ old('discount_from') }}">
                                            @error('discount_from')
                                                <p class="mb-0 text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-sm-3">
                                            <input type="datetime-local" name="discount_to" class="form-control" value="{{ old('discount_to') }}">
                                            @error('discount_to')
                                                <p class="mb-0 text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="warranty" id="inlineRadio1" value="1">
                                                <label class="form-check-label" for="inlineRadio1">Active</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="warranty" id="inlineRadio2" value="0" checked>
                                                <label class="form-check-label" for="inlineRadio2">Inactive</label>
                                            </div>
                                        </div>
                                        <label for="inputPhoneNo2" class="col-sm-2 col-form-label text-lg-end">Duration</label>
                                        <div class="col-sm-3">
                                            <input type="text" name="warranty_duration" class="form-control" placeholder="6 Month/ 1 Year" value="{{ old('warranty_duration') }}">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                            ...
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" name="is_free_shipping" value="yes" type="checkbox" id="flexSwitchCheckChecked" checked="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" name="show_stock_qty" value="yes" type="checkbox" id="flexSwitchCheckChecked" checked="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" name="cash_on_delivery" value="yes" type="checkbox" id="flexSwitchCheckChecked" checked="">
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="number" name="low_stock_qty" value="{{ old('low_stock_qty') ? old('low_stock_qty') : 0 }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label for="" class="col-sm-6 col-form-label">Estimate Shipping Day </label>
                                        <div class="col-sm-6">
                                            <input type="text" name="estimate_shipping_day" value="{{ old('estimate_shipping_day') }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
