            ...
            <form action="{{ route('checkout.orderStore') }}" method="POST">
                ...
                <div class="row">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="Your Name" value="{{ $customer->name }}" required style="height: 44px">
                                    @error('name')
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" readonly class="form-control @error('phone') is-invalid @enderror" name="phone" id="phone" placeholder="11 Digit Number" value="{{ $customer->phone }}" required style="height: 44px">
                                    @error('phone')
                                        <div class="text-danger" style="font-size: 12px">
                                            {{ $message }} </div>
                                    @enderror
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="name">Full Name *</label>
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="Your Name" value="{{ old('name') }}" required style="height: 44px">
                                    @error('name')
                                        <div class="text-danger" style="font-size: 12px">
                                            {{ $message }} </div>
                                    @enderror
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    <label for="phone">Phone Number *</label>
                                    <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" id="phone" placeholder="11 Digit Number" value="{{ old('phone') }}" required style="height: 44px">
                                    @error('phone')
                                        <div class="text-danger" style="font-size: 12px">
                                            {{ $message }} </div>
                                    @enderror
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('address') is-invalid @enderror" name="address" cols="30" rows="4" placeholder="Adderess" required>{{ old('address') }}</textarea>
                                    @error('address')
                                        <div class="text-danger" style="font-size: 12px">
                                            {{ $message }} </div>
                                    @enderror
                    ...
                    <div class="col-lg-6">
                        <div class="order-summary">
                                    ...
                                    <tbody>
                                        @foreach (\Cart::content() as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="product-title cartItem" style="font-size: 12px; text-align:start">
                                                        <a href="{{ route('product', $item->options->slug) }}">{{ $item->name }}</a>
                                                    </p>
                                                    <span class="product-qty" style="font-size: 12px;">Price: {{ $item->price }}</span>
                                                    <span class="product-qty" style="font-size: 12px;">Size: {{ $item->options->size }}</span>
                                                    <span class="product-qty d-flex" style="font-size: 12px;">Color: <div class="ms-2" style="height: 15px;width: 15px;background-color:{{ $item->options->color == '' ? '' : colorCode($item->options->color) }}"></div></span>
                                                </td>
                                                <td>
                                                    <div class = "d-flex me-3">
                                                        ...
                                                        <input type="number" style="font-size:14px;text-align:center;height:35px;width:70px;margin-bottom: 0px;padding:0px" id="quantity" oninput="updateCart(this.value, '{{ $item->rowId }}')" class="form-control" name="quantity" value="{{ $item->qty }}" min="1">
                                                ...
                                                <td>
                                                    <a href="{{ route('cart.remove', $item->rowId) }}" style="font-size: 12px;padding:5px;color:red;font-weight:bold">X</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                            ...
                            <h4 class="font-weight-normal" style="font-size: 13px">
                                ...
                                <div class="">
                                    <input class="form-check-input" type="radio" name="delivery_charge" value="inside" id="inside" checked onchange="updateDeliveryCharge();">
                                    <label class="form-check-label" for="inside" style="font-weight: normal;margin-right:15px">Inside Dhaka</label>
                                    <input class="form-check-input" type="radio" name="delivery_charge" value="outside" id="outside" onchange="updateDeliveryCharge();">
                                    <label class="form-check-label" for="outside" style="font-weight: normal">Outside Dhaka</label>
                                </div>
                            ...
                            <h4>
                                <div class="d-flex justify-content-between pt-3 h4">
                                    ...
                                    <span id="subtotalsum">&#2547; {{ number_format((float) str_replace(',', '', Cart::subtotal()) + 100.0, 2) }}</span>
                    ...
                    <div class="col-lg-6 offset-lg-3 mt-4 text-center">
                        <p class="small">অর্ডারটি কনফার্ম করতে ফর্মটি সম্পুর্ণ পুরণ করে নিচের Place Order বাটনে ক্লিক করুন।</p>
                        <div class="d-grid">
