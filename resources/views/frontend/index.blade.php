        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="search-content">
                            ...
                            <div class="banner banner1 banner-hover-shadow mb-2">
                                <a href="{{ $banner->link }}">
                                    ...
                                    <h4 class="m-b-4 text-primary"><sup class="text-dark"><del>20%</del></sup>30%<sup>OFF</sup>
                                        ...
                                        {{-- <a href="#" class="btn btn-outline-dark btn-sm  text-uppercase ls-10">Shop Now</a> --}}
                                    </div>
                                </a>
                            </div><!-- End .banner -->
                        @endforeach
                                                            ...
                                                            <a href="{{ route('product', $product->slug) }}">
                                                                <div class="product"> <img src="{{ singlePhoto(json_decode($product->thumbnail)) }}" alt="">
                                                                    <ul class="d-flex align-items-center justify-content-center list-unstyled icons">
                                                                        ...
                                                                        {{-- <a href="{{ route('store.from.icon', $product->slug) }}">
                                                                ...
                                                                <div class="card-title pt-4 pb-1 px-2">{{ $product->name }}</div>
                    ...
                    <section class="my-3">
                        <div class="row">
                            <a href="{{ $singleBanner->link }}" class="tokoo-banner-link">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-lg-4">
                                    <div class="row row-cols-md-2 row-cols-lg-2 g-3">
                                        @foreach ($sectionsNew[0]->products->take(4) as $leftItem)
                                            <div class="col">
                                                <div class="card h-100 col d-flex flex-column align-items-center new product-item mb-0">
                                                    <a href="{{ route('product', $leftItem->slug) }}">
                                                        <div class="product"> <img src="{{ singlePhoto(json_decode($leftItem->thumbnail)) }}" alt="" style="max-width:175px;margin: 0px auto;">
                                                            <ul class="d-flex align-items-center justify-content-center list-unstyled icons">
                                                                ...
                                                                {{-- <a href="javascript;" id="add-to-cart" class="add-cart"> --}}
                                                                <a href="{{ route('product', $leftItem->slug) }}">
                                                                    {{-- <input type = "hidden" id = "id" name = "id" value = "{{ $product->id }}"> --}}
                                                                    <li class="icon"><span class="fas fa-shopping-bag"></span></li>
                                                                </a>
                                                        ...
                                                        {{-- <div class="tag bg-red">sale</div> --}}
                                                        <div class="card-title pt-4 pb-1 px-2">{{ $leftItem->name }}</div>
                                                        <div class="d-flex align-content-center justify-content-center"> <span class="fas fa-star"></span> <span class="fas fa-star"></span> <span class="fas fa-star"></span> <span class="fas fa-star"></span> <span class="fas fa-star"></span> </div>

                                                        <div class="price">
                                                            @if (productPrice($product->id) < $leftItem->selling_price)
                                                                <span><del class="price">&#2547; {{ $leftItem->selling_price }}</del></span>
                                                            @endif
                                                            <span class="text-danger"><del>&#2547; {{ number_format($leftItem->selling_price) }}</del></span>
                                                            @php
                                                                $mainPrice = $leftItem->selling_price - $leftItem->discount_price;
                                                            @endphp
                                ...
                                <div class="col-md-4 d-none d-lg-block">
                                    <div class="card h-100 col d-flex flex-column align-items-center product-item">
                                        <a href="{{ route('product', $singleCardProduct->slug) }}">
                                            <div class="single_card border-bottom p-5">
                                                <img src="{{ singlePhoto(json_decode($singleCardProduct->thumbnail)) }}" alt="">
                                            </div>
                                            {{-- <div class="tag bg-red">sale</div> --}}
                                            <div class="card-title pt-4 pb-1 text-center px-2">{{ $singleCardProduct->name }}</div>
                                            <div class="d-flex align-content-center justify-content-center"> <span class="fas fa-star"></span> <span class="fas fa-star"></span> <span class="fas fa-star"></span> <span class="fas fa-star"></span> <span class="fas fa-star"></span> </div>

                                            <div class="price text-center px-2">
                                                @if (productPrice($product->id) < $product->selling_price)
                                                    <span><del class="price">&#2547; {{ $product->selling_price }}</del></span>
                                                @endif
                                                <del class="text-danger">&#2547; {{ number_format($singleCardProduct->selling_price) }}</del>
                                                @php
                                                    $mainPrice = $singleCardProduct->selling_price - $singleCardProduct->discount_price;
                                                @endphp
                                                <span class="text-success">&#2547; {{ $mainPrice }}</span>
                                            </div>
                                            <div class="">
                                                <a href="{{ route('product', $singleCardProduct->slug) }}" class="btn btn-success px-5 py-3">Add To Cart</a>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-6 col-lg-4">
                                    <div class="row row-cols-md-2 row-cols-lg-2 g-3">
                                        @foreach ($sectionsNew[0]->products->skip(4)->take(4) as $leftItem)
                                            <div class="col">
                                                <div class="card h-100 col d-flex flex-column align-items-center new product-item mb-0">
                                                    <a href="{{ route('product', $leftItem->slug) }}">
                                                        <div class="product"> <img src="{{ singlePhoto(json_decode($leftItem->thumbnail)) }}" alt="" style="max-width:175px;margin: 0px auto;">
                        ...
                        <div class="container my-5">
                            ...
                            <div class="row row-cols-2 rol-cols-md-3 row-cols-lg-4 g-3">
                                @foreach ($categories->take(8) as $category)
                                    <div class="col">
                                        <a href="{{ route('product.bycategory', $category->slug) }}">
                                            <div class="card h-100 col d-flex flex-column align-items-center product-item my-3" style="background-color: {{ getAnyColor($loop->index) }};">
                                                <div class="p-5">
                                                    <img src="{{ asset('') . $category->image }}" alt="">
                                                    <div class=" text-center text-uppercase pt-4 text-dark">{{ $category->name }}</div>
                                ...
                                <div class="col">
                                    <div class="card h-100 col d-flex flex-column align-items-center product-item my-3" style="background-color: #cdc9a9;">
                                        <div class="p-5">
